...
class dataProcess(object):
    ...
    def load_train_data(self, file_path):
        ...
        print('-' * 30)
        imgs_train = np.load(file_path + "_imgs_train.npy")
        print("path===>" + file_path + "_imgs_train.npy")
        imgs_mask_train = np.load(file_path + "_imgs_mask_train.npy")
    ...
    def load_test_data(self, file_path):
        ...
        print('-' * 30)
        imgs_test = np.load(file_path + "_imgs_train.npy")
